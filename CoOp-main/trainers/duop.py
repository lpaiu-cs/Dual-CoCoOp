...
class PromptLearner(nn.Module):
    ...
    def __init__(self, cfg, classnames, captions, clip_model, device='cpu'):
        ...
        self.n_ctx = cfg.TRAINER.DUOP.N_CTX
        ctx_init = cfg.TRAINER.DUOP.CTX_INIT
        self.dtype = clip_model.dtype
        ...
        # self.class_token_position = cfg.TRAINER.DUOP.PI_TOKEN_POSITION # 'on_ctx', 'off_ctx'
...
class DuOp(TrainerX):
    def build_model(self):
        ...
        if cfg.TRAINER.DUOP.PREC == "fp32" or cfg.TRAINER.DUOP.PREC == "amp":
            clip_model.float()
        ...
        self.scaler = GradScaler() if cfg.TRAINER.DUOP.PREC == "amp" else None
    ...
    def forward_backward(self, batch):
        ...
        prec = self.cfg.TRAINER.DUOP.PREC
        if prec == "amp":
            with autocast():
